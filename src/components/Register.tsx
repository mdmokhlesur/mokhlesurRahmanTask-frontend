  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary/5 p-6">
      <div className="w-full max-w-[500px] bg-white rounded-lg shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] p-8 border border-slate-100 transition-all duration-300">
               {/* Register page title */}
               <div className="mb-6">
          <h2 className="text-[1.8rem] font-semibold text-slate-900 tracking-tight mb-1">Create an account</h2>
        </div>
    ...
    {/* First name and Last name */}
       ...
       <input 
         ...
         <p className="mt-4 text-center text-sm text-slate-500">
                   Already have an account? <Link to="/login" className="text-primary font-medium no-underline ml-1 hover:underline">Log in</Link>
          </p>
      </div>
    </div>
